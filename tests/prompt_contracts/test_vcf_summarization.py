...
CONTRACT_PATH = os.path.join(os.path.dirname(__file__), '../../prompts/vcf_summarization_v1.yaml')
...
def agent_response(input_path, seed):
    ...
    prompt = f"vcf_summarization: {input_path}"
...
def test_vcf_summarization_contract():
    contract = load_contract()
